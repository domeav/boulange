...
urlpatterns = [
    ...
    path("hx/customer_search/", views.hx_customer_search, name="hx_customer_search"),
    ...
    path("customer_orders_print/", views.customer_orders, name="customer_orders_print", kwargs={"to_print": True}),
