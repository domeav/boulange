# Generated by Django 5.1.4 on 2025-01-12 07:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("per_unit_price", models.DecimalField(decimal_places=3, help_text="price per Kg, liter or unit", max_digits=5)),
                ("needs_soaking", models.BooleanField(default=False)),
                ("soaking_coef", models.FloatField(default=1)),
            ],
            options={
                "indexes": [models.Index(fields=["name"], name="boulange_in_name_c6657a_idx")],
            },
        ),
        migrations.CreateModel(
            name="Order",
            fields=[
                ...
                ("delivery_date", models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to="boulange.deliverydate")),
            ],
        ),
        migrations.CreateModel(
            name="Product",
            fields=[
                ...
                ("orig_product", models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to="boulange.product")),
            ],
        ),
        migrations.CreateModel(
            name="OrderLine",
            fields=[
                ...
                ("order", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="lines", to="boulange.order")),
                ("product", models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to="boulange.product")),
            ],
        ),
        migrations.CreateModel(
            name="ProductLine",
            fields=[
                ...
                ("ingredient", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="boulange.ingredient")),
                ("product", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="raw_ingredients", to="boulange.product")),
            ],
        ),
        migrations.CreateModel(
            name="WeeklyDelivery",
            fields=[
                ("id", models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("active", models.BooleanField(default=True)),
                ("batch_target", models.CharField(choices=[("SAME_DAY", "same day"), ("PREVIOUS_DAY", "previous day")], default="SAME_DAY", max_length=20)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to="boulange.weeklydelivery"),
        ),
        migrations.AddIndex(
            model_name="product",
